package com.photo.photography.collage.action;
 ...
 */
public class ActionQuick extends PopupWindowsAction implements OnDismissListener {
    ...
    private final List<ActionQuickItem> mQuickActionItems = new ArrayList<ActionQuickItem>();
     ...
     */
    public ActionQuick(Context context) {
     ...
     */
    public ActionQuick(Context context, int orientation) {
        super(context);
        ...
        if (mOrientation == HORIZONTAL) {
            setRootViewId(R.layout.popup_horiz);
        } else {
            setRootViewId(R.layout.popup_verticals);
        }
     ...
     */
    public ActionQuickItem getActionItem(int index) {
     ...
     * Add action item
     *
     * @param action {@link ActionQuickItem}
     */
    public void addActionItem(ActionQuickItem action) {
        ...
        if (mOrientation == HORIZONTAL) {
            container = mInflater.inflate(R.layout.action_items_horizontal, null);
        } else {
            container = mInflater.inflate(R.layout.action_items_vertical, null);
        }
        ...
        container.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mItemClickListener != null) {
                    mItemClickListener.onItemClick(ActionQuick.this, pos, actionId);
                }
        ...
        if (mOrientation == HORIZONTAL && mChildPos != 0) {
            View separator = mInflater.inflate(R.layout.horizontal_separator, null);
     ...
     */
    public void setOnDismissListener(ActionQuick.OnDismissListener listener) {
    ...
    public interface OnActionItemClickListener {
        void onItemClick(ActionQuick source, int pos, int actionId);
    }
