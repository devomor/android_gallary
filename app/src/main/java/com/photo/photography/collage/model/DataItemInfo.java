 ...
 * @author vanhu_000
 */
public class DataItemInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<DataItemInfo> CREATOR
            = new Parcelable.Creator<DataItemInfo>() {
        public DataItemInfo createFromParcel(Parcel in) {
            return new DataItemInfo(in);
        }

        public DataItemInfo[] newArray(int size) {
            return new DataItemInfo[size];
        }
    };
    ...
    protected DataItemInfo(Parcel in) {
