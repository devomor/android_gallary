...
public class ActFrameDetail extends ActBaseTemplateDetail implements FramePhotoLayout.OnQuickActionClickListener, ColorPickDialog.OnColorChangedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBackgroundColor = ContextCompat.getColor(this, R.color.white_new);
        ...
        if (savedInstanceState != null) {
            ...
            if (mBackgroundUri != null)
                mBackgroundImage = ImageDecoderUtil.decodeUriToBitmap(this, mBackgroundUri);
        }
...
//        mAddImageDialog.findViewById(R.id.dividerTextView).setVisibility(View.VISIBLE);
    ...
    @Override
    protected void buildLayout(DataTemplateItem item) {
    ...
    protected void resultEditImage(Uri uri) {
        if (mSelectedFrameImageView != null) {
            mSelectedFrameImageView.setImagePath(CollageFilesUtils.getPath(this, uri));
        }
    }
    ...
    protected void resultBackground(Uri uri) {
        ...
        mBackgroundUri = uri;
        mBackgroundImage = ImageDecoderUtil.decodeUriToBitmap(this, uri);
        BitmapDrawable bitmapDrawable = new BitmapDrawable(getResources(), mBackgroundImage);
        bitmapDrawable.setTileModeXY(Shader.TileMode.REPEAT, Shader.TileMode.REPEAT);
        if (Build.VERSION.SDK_INT >= 16) {
            mContainerLayout.setBackground(bitmapDrawable);
