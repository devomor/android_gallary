...
//        mFirebaseAnalytics = FirebaseAnalytics.getInstance(mActivity);
    ...
    protected void setTitle() {
        ...
        } else if (this instanceof FragColorChooser) {
    ...
    private void startPhotoEditor(Uri imageUri, boolean capturedFromCamera) {
        ...
        HelperALog.d("BaseFragment", "startPhotoEditor, imageUri=" + imageUri + ", capturedFromCamera=" + capturedFromCamera);
...
//    }
    ...
    protected Uri getImageUri() {
        // Store image in dcim
        File file = new File(new VaultFileUtil(getActivity()).getFile("DCIM"), CAPTURE_TITLE);
