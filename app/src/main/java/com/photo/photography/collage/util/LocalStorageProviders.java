...
public class LocalStorageProviders extends DocumentsProvider {
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        // Add Home directory
        File homeDir = new VaultFileUtil(MyApp.mContext).getDir();
        ...
        row.add(Root.COLUMN_ICON, R.drawable.icon_photo_editor_ic_launcher);
    ...
    public String createDocument(final String parentDocumentId, final String mimeType,
        ...
        try {
            ...
            Log.e(LocalStorageProviders.class.getSimpleName(), "Error creating new file " + newFile);
        }
        return null;
    }
    ...
    public AssetFileDescriptor openDocumentThumbnail(final String documentId, final Point sizeHint,
        ...
        try {
            ...
            Log.e(LocalStorageProviders.class.getSimpleName(), "Error writing thumbnail", e);
            return null;
        } finally {
            if (out != null)
                try {
                    ...
                    Log.e(LocalStorageProviders.class.getSimpleName(), "Error closing thumbnail", e);
                }
        }
