...
import com.photo.photography.collage.model.DataFontItem;
...
public class TextUtil {
    ...
    public static List<DataFontItem> loadFonts(Context context) {
        final List<DataFontItem> result = new ArrayList<DataFontItem>();
        DataFontItem defaultFont = new DataFontItem(context.getString(R.string.default_font), null);
        ...
        try {
            ...
            if (fontNames != null) {
                for (String name : fontNames) {
                    DataFontItem item = new DataFontItem(name.substring(0, name.length() - 4),
