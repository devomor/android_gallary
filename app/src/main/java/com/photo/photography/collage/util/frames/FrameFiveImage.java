...
/**
 * Created by Sira on 6/24/2018.
 */
public class FrameFiveImage {
    static DataTemplateItem collage_5_31() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_31.png");
        //first frame
    ...
    static DataTemplateItem collage_5_30() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_30.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 1, 0.3333f);
    ...
    static DataTemplateItem collage_5_29() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_29.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.shrinkMethod = PhotoItemCustom.SHRINK_METHOD_COMMON;
    ...
    static DataTemplateItem collage_5_28() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_28.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.shrinkMethod = PhotoItemCustom.SHRINK_METHOD_COMMON;
    ...
    static DataTemplateItem collage_5_27() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_27.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.shrinkMethod = PhotoItemCustom.SHRINK_METHOD_COMMON;
    ...
    static DataTemplateItem collage_5_26() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_26.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.shrinkMethod = PhotoItemCustom.SHRINK_METHOD_COMMON;
    ...
    static DataTemplateItem collage_5_25() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_25.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.shrinkMethod = PhotoItemCustom.SHRINK_METHOD_COMMON;
    ...
    static DataTemplateItem collage_5_24() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_24.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.shrinkMethod = PhotoItemCustom.SHRINK_METHOD_COMMON;
    ...
    static DataTemplateItem collage_5_23() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_23.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.shrinkMethod = PhotoItemCustom.SHRINK_METHOD_COMMON;
    ...
    static DataTemplateItem collage_5_22() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_22.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.shrinkMethod = PhotoItemCustom.SHRINK_METHOD_COMMON;
    ...
    static DataTemplateItem collage_5_21() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_21.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.shrinkMethod = PhotoItemCustom.SHRINK_METHOD_COMMON;
    ...
    static DataTemplateItem collage_5_20() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_20.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
    ...
    static DataTemplateItem collage_5_19() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_19.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
    ...
    static DataTemplateItem collage_5_18() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_18.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.6f, 0.3333f);
    ...
    static DataTemplateItem collage_5_17() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_17.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.5f, 0.3333f);
    ...
    static DataTemplateItem collage_5_16() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_16.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 1, 0.3333f);
    ...
    static DataTemplateItem collage_5_15() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_15.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
    ...
    static DataTemplateItem collage_5_14() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_14.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
    ...
    static DataTemplateItem collage_5_13() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_13.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.3333f, 1);
    ...
    static DataTemplateItem collage_5_12() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_12.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
    ...
    static DataTemplateItem collage_5_11() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_11.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
    ...
    static DataTemplateItem collage_5_10() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_10.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
    ...
    static DataTemplateItem collage_5_9() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_9.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.3333f, 0.3333f);
    ...
    static DataTemplateItem collage_5_8() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_8.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
    ...
    static DataTemplateItem collage_5_6() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_6.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.shrinkMethod = PhotoItemCustom.SHRINK_METHOD_COMMON;
    ...
    static DataTemplateItem collage_5_7() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_7.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.5f, 0.5f);
    ...
    static DataTemplateItem collage_5_5() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_5.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.5f, 0.5f);
    ...
    static DataTemplateItem collage_5_4() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_4.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.3333f, 0.5f);
    ...
    static DataTemplateItem collage_5_3() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_3.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.shrinkMethod = PhotoItemCustom.SHRINK_METHOD_COMMON;
    ...
    static DataTemplateItem collage_5_2() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_2.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.5f, 0.5f);
    ...
    static DataTemplateItem collage_5_1() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_1.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.shrinkMethod = PhotoItemCustom.SHRINK_METHOD_COMMON;
    ...
    static DataTemplateItem collage_5_0() {
        DataTemplateItem item = FrameImageUtils.collage("collage_5_0.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
