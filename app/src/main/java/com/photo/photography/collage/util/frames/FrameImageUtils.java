...
/**
 * Created by Sira on 5/6/2018.
 */
public class FrameImageUtils {
    public static final String FRAME_FOLDER = "frame";

    protected static DataTemplateItem collage(String frameName) {
    ...
    private static DataTemplateItem collage_1_0() {
        DataTemplateItem item = collage("collage_1_0.png");
    ...
    public static ArrayList<DataTemplateItem> loadFrameImages(Context context) {
        ...
        try {
            ...
            if (frameNames != null && frameNames.length > 0) {
                for (String str : frameNames) {
                    DataTemplateItem item = createTemplateItems(str);
                    if (item != null)
                        templateItemList.add(item);
                }

                Collections.sort(templateItemList, new Comparator<DataTemplateItem>() {
                    @Override
                    public int compare(DataTemplateItem lhs, DataTemplateItem rhs) {
    ...
    private static DataTemplateItem createTemplateItems(String frameName) {
