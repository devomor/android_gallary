...
/**
 * Created by Sira on 6/30/2018.
 */
public class FrameSevenImage {
    static DataTemplateItem collage_7_10() {
        DataTemplateItem item = FrameImageUtils.collage("collage_7_10.png");
        //first frame
    ...
    static DataTemplateItem collage_7_9() {
        DataTemplateItem item = FrameImageUtils.collage("collage_7_9.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
    ...
    static DataTemplateItem collage_7_8() {
        DataTemplateItem item = FrameImageUtils.collage("collage_7_8.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
    ...
    static DataTemplateItem collage_7_7() {
        DataTemplateItem item = FrameImageUtils.collage("collage_7_7.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
    ...
    static DataTemplateItem collage_7_6() {
        DataTemplateItem item = FrameImageUtils.collage("collage_7_6.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.6666f, 0.3333f);
    ...
    static DataTemplateItem collage_7_5() {
        DataTemplateItem item = FrameImageUtils.collage("collage_7_5.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
    ...
    static DataTemplateItem collage_7_4() {
        DataTemplateItem item = FrameImageUtils.collage("collage_7_4.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.3333f, 0.3333f);
    ...
    static DataTemplateItem collage_7_3() {
        DataTemplateItem item = FrameImageUtils.collage("collage_7_3.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.3333f, 0.3333f);
    ...
    static DataTemplateItem collage_7_2() {
        DataTemplateItem item = FrameImageUtils.collage("collage_7_2.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
    ...
    static DataTemplateItem collage_7_1() {
        DataTemplateItem item = FrameImageUtils.collage("collage_7_1.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
    ...
    static DataTemplateItem collage_7_0() {
        DataTemplateItem item = FrameImageUtils.collage("collage_7_0.png");
        //first frame
        PhotoItemCustom photoItem = new PhotoItemCustom();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.3333f, 0.3333f);
