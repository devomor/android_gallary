...
public class AlphaColorSelectView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private CallbackOnChooseAlphaColor mListener;

    public AlphaColorSelectView(Context context) {
        super(context);
        init();
    }

    public AlphaColorSelectView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int idx = MAX_ALPHA; idx >= MIN_ALPHA; idx--) {
            ...
            right = left + d;
            int color = Color.argb(idx, mOriginalRed, mOriginalGreen, mOriginalBlue);
    ...
    public void setListener(CallbackOnChooseAlphaColor listener) {
        mListener = listener;
    }
    ...
    private void init() {
        mCircleColor = getContext().getResources().getColor(R.color.color_chooser_cirlce);
        mCircleSmallRadius = getContext().getResources().getDimension(R.dimen.color_chooser_circle_radius_small);
        mCircleLargeRadius = getContext().getResources().getDimension(R.dimen.color_chooser_circle_radius_large);
        mCircleBorderColor = getContext().getResources().getColor(R.color.color_chooser_circle_border);
        mPaint.setAntiAlias(true);
        mPaint.setStyle(Paint.Style.FILL_AND_STROKE);
        mStrokeWidth = getContext().getResources().getDimension(R.dimen.stroke_width);
