...
public class MultiTouchHandl implements Parcelable {
    public static final Creator<MultiTouchHandl> CREATOR = new Creator<MultiTouchHandl>() {
        public MultiTouchHandl createFromParcel(Parcel in) {
            return new MultiTouchHandl(in);
        }

        public MultiTouchHandl[] newArray(int size) {
            return new MultiTouchHandl[size];
        }
    };
    ...
    public MultiTouchHandl() {

    }

    private MultiTouchHandl(Parcel in) {
