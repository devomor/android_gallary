...
import com.photo.photography.collage.view.horizontalList.util.CallbackMultiChoiceMode;
import com.photo.photography.collage.view.horizontalList.util.MultiChoiceModeWrap;
import com.photo.photography.collage.view.horizontalList.util.ViewHelperFactories;
import com.photo.photography.collage.view.horizontalList.util.ViewHelperFactories.ViewHelper;
...
public abstract class AbsHListViews extends AdapterViews<ListAdapter> implements
     ...
     * Acts upon click
     */
    private AbsHListViews.PerformClick mPerformClick;
    /**
     ...
     */
    private EdgeEffects mEdgeGlowTop;
    /**
     * Tracks the state of the bottom edge glow.
     */
    private EdgeEffects mEdgeGlowBottom;
    /**
    ...
    public AbsHListViews(Context context) {
        super(context);
        initAbsListView();
    }

    public AbsHListViews(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.hlv_absHListViewStyle);
    }

    public AbsHListViews(Context context, AttributeSet attrs, int defStyle) {
    ...
    static View retrieveFromScrap(ArrayList<View> scrapViews, int position) {
        ...
        if (size > 0) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (((AbsHListViews.LayoutParams) view.getLayoutParams()).scrappedFromPosition == position) {
                    scrapViews.remove(i);
                    return view;
                }
            }
    ...
    private void initAbsListView() {
        ...
        mViewHelper = ViewHelperFactories.create(this);
    }
    ...
    public void setOverScrollMode(int mode) {
        if (mode != OVER_SCROLL_NEVER) {
            if (mEdgeGlowTop == null) {
                ...
                mEdgeGlowTop = new EdgeEffects(context,
                        EdgeEffects.DIRECTION_HORIZONTAL);
                mEdgeGlowBottom = new EdgeEffects(context,
                        EdgeEffects.DIRECTION_HORIZONTAL);
            }
        } else {
            mEdgeGlowTop = null;
        ...
        if (android.os.Build.VERSION.SDK_INT >= 11) {
            if (value && mChoiceMode == ListView.CHOICE_MODE_MULTIPLE_MODAL
                ...
                if (mMultiChoiceModeCallback == null
                        || !((MultiChoiceModeWrap) mMultiChoiceModeCallback)
                        .hasWrappedCallback()) {
                ...
                mChoiceActionMode = startActionMode((MultiChoiceModeWrap) mMultiChoiceModeCallback);
            }
        }
    ...
    /**
     * Set a {@link CallbackMultiChoiceMode} that will manage the lifecycle of
     ...
     */
    @TargetApi(11)
    public void setMultiChoiceModeListener(CallbackMultiChoiceMode listener) {
        if (android.os.Build.VERSION.SDK_INT >= 11) {
            if (mMultiChoiceModeCallback == null) {
                mMultiChoiceModeCallback = new MultiChoiceModeWrap(this);
            }
            ((MultiChoiceModeWrap) mMultiChoiceModeCallback)
                    .setWrapped(listener);
        } else {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(AbsHListViews.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(AbsHListViews.class.getName());
        if (isEnabled()) {
    ...
    boolean performLongPress(final View child, final int longPressPosition,
        ...
        if (android.os.Build.VERSION.SDK_INT >= 11) {
            if (mChoiceMode == ListView.CHOICE_MODE_MULTIPLE_MODAL) {
                if (mChoiceActionMode == null
                        && (mChoiceActionMode = startActionMode((MultiChoiceModeWrap) mMultiChoiceModeCallback)) != null) {
        ...
        if (mOnItemLongClickListener != null) {
            handled = mOnItemLongClickListener.onItemLongClick(
                    AbsHListViews.this, child, longPressPosition, longPressId);
        }
        if (!handled) {
            mContextMenuInfo = createContextMenuInfo(child, longPressPosition,
                    longPressId);
            handled = super.showContextMenuForChild(AbsHListViews.this);
        }
        if (handled) {
            performHapticFeedback(HapticFeedbackConstants.LONG_PRESS);
        }
    ...
    public boolean showContextMenu(float x, float y, int metaState) {
        ...
        if (position != INVALID_POSITION) {
            ...
            if (child != null) {
                ...
                return super.showContextMenuForChild(AbsHListViews.this);
            }
        }
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (mOnItemLongClickListener != null) {
                handled = mOnItemLongClickListener.onItemLongClick(
                        AbsHListViews.this, originalView, longPressPosition,
                        longPressId);
            }
            if (!handled) {
                ...
                switch (mTouchMode) {
                    ...
                    case TOUCH_MODE_DONE_WAITING:
                        ...
                        if (child != null && !child.hasFocusable() && inList) {
                            ...
                            final AbsHListViews.PerformClick performClick = mPerformClick;
     ...
     * {@link AbsHListViews.OnScrollListener}
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        return new AbsHListViews.LayoutParams(
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new AbsHListViews.LayoutParams(getContext(), attrs);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof AbsHListViews.LayoutParams;
    }
    ...
    public void reclaimViews(List<View> views) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            AbsHListViews.LayoutParams lp = (AbsHListViews.LayoutParams) child
                    .getLayoutParams();
     ...
     *                 recycler.
     * @see AbsHListViews.RecycleBin
     * @see AbsHListViews.RecyclerListener
     */
    ...
    public interface OnScrollListener {
         ...
         *                    {@link #SCROLL_STATE_IDLE}.
         */
        void onScrollStateChanged(AbsHListViews view, int scrollState);
         ...
         */
        void onScroll(AbsHListViews view, int firstVisibleItem,
     ...
     *
     * @see AbsHListViews.RecycleBin
     * @see AbsHListViews#setRecyclerListener(AbsHListViews.RecyclerListener)
     */
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link AbsHListViews#onSaveInstanceState()}
         */
    ...
    private class FlingRunnable implements Runnable {
         ...
         */
        private final OverScrollerView mScroller;
        private final Runnable mCheckFlywheel = new Runnable() {
            ...
            public void run() {
                ...
                final OverScrollerView scroller = mScroller;
        ...
        FlingRunnable() {
            mScroller = new OverScrollerView(getContext());
        }
    ...
    public class AdapterDataSetObserver extends
            AdapterViews<ListAdapter>.AdapterDataSetObserver {
    ...
    public class RecycleBin {
        ...
        public void addScrapView(View scrap, int position) {
            AbsHListViews.LayoutParams lp = (AbsHListViews.LayoutParams) scrap
                    .getLayoutParams();
            if (lp == null) {
                return;
            }
        ...
        public void scrapActiveViews() {
            ...
            for (int i = count - 1; i >= 0; i--) {
                ...
                if (victim != null) {
                    final AbsHListViews.LayoutParams lp = (AbsHListViews.LayoutParams) victim
                            .getLayoutParams();
