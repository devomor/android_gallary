 ...
 */
public abstract class AdapterViews<T extends Adapter> extends ViewGroup {
    ...
    public AdapterViews(Context context) {
        super(context);
    }

    public AdapterViews(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    @TargetApi(16)
    public AdapterViews(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(AdapterViews.class.getName());
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(AdapterViews.class.getName());
    ...
    public interface OnItemClickListener {
         ...
         * @param id       The col id of the item that was clicked.
         */
        void onItemClick(AdapterViews<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         */
        boolean onItemLongClick(AdapterViews<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(AdapterViews<?> parent, View view, int position, long id);
         ...
         */
        void onNothingSelected(AdapterViews<?> parent);
    }
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (AdapterViews.this.getAdapter().hasStableIds() && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                if (LOG_ENABLED) {
                    Log.d(LOG_TAG, "calling onRestoreInstanceState");
                }
                AdapterViews.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                if (LOG_ENABLED) {
        ...
        public void onInvalidated() {
            ...
            if (AdapterViews.this.getAdapter().hasStableIds()) {
                // Remember the current state for the case where our hosting activity is being
                // stopped and later restarted
                mInstanceState = AdapterViews.this.onSaveInstanceState();
            }
