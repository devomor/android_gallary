...
public class EdgeEffects {
     ...
     * context.
     *
     * @param context Context used to provide theming and resource information for
     *                the EdgeEffect
     */
    public EdgeEffects(Context context, int direction) {
        final Resources res = context.getResources();
        mEdge = res.getDrawable(R.drawable.icon_photo_editor_hlv_overscroll_edge);
        mGlow = res.getDrawable(R.drawable.icon_photo_editor_hlv_overscroll_glow);
     ...
     * accordingly.
     *
     * @param deltaDistance Change in distance since the last call. Values may be 0 (no
