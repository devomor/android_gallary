...
package com.photo.photography.collage.view.horizontalList.widget;
 ...
 * differs from the {@link HListViews} by
 ...
 * default style for an {@link ExpandableHListViews} provides indicators which
 * will be shown next to Views given to the {@link ExpandableHListViews}. The
 ...
 * <p/>
 * The context menu information set by an {@link ExpandableHListViews} will be a
 ...
 */
public class ExpandableHListViews extends HListViews {
     ...
     * ExpandableListView
     */
    private ExpandableHListConnect mConnector;
    /**
    ...
    public ExpandableHListViews(Context context) {
        this(context, null);
    }

    public ExpandableHListViews(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.hlv_expandableListViewStyle);
    }

    public ExpandableHListViews(Context context, AttributeSet attrs, int defStyle) {
     ...
     * {@link #getPackedPositionForChild(int, int)}.
     *
     * @param packedPosition The packed position from which the group position will be
     *                       returned.
     ...
     * {@link #getPackedPositionForChild(int, int)}.
     *
     * @param packedPosition The packed position from which the child position will be
     *                       returned.
     ...
     * {@link ExpandableHListViews} method can either be a child or group. The
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        ExpandableHListConnect.PositionMetadata pos;
        View item;
        Drawable indicator;
        int left, right;

        // Start at a value that is neither child nor group
        int lastItemType = ~(ExpandableHListPos.CHILD | ExpandableHListPos.GROUP);
        ...
        for (int i = 0, childFlPos = mFirstPosition - headerViewsCount; i < childCount; i++, childFlPos++) {
            ...
            if (pos.position.type != lastItemType) {
                if (pos.position.type == ExpandableHListPos.CHILD) {
     ...
     */
    private Drawable getIndicator(ExpandableHListConnect.PositionMetadata pos) {
        Drawable indicator;

        if (pos.position.type == ExpandableHListPos.GROUP) {
    ...
    void drawDivider(Canvas canvas, Rect bounds, int childIndex) {
        ...
        if (flatListPosition >= 0) {
            ...
            ExpandableHListConnect.PositionMetadata pos = mConnector
    ...
    public void setAdapter(ExpandableListAdapter adapter) {
        ...
        if (adapter != null) {
            ...
            mConnector = new ExpandableHListConnect(adapter);
        } else {
            mConnector = null;
        }
    ...
    boolean handleItemClick(View v, int position, long id) {
        final ExpandableHListConnect.PositionMetadata posMetadata = mConnector
                .getUnflattenedPos(position);

        id = getChildOrGroupId(posMetadata.position);

        boolean returnValue;
        if (posMetadata.position.type == ExpandableHListPos.GROUP) {
    ...
    public boolean expandGroup(int groupPos, boolean animate) {
        ExpandableHListPos elGroupPos = ExpandableHListPos.obtain(
                ExpandableHListPos.GROUP, groupPos, -1, -1);
        ExpandableHListConnect.PositionMetadata pm = mConnector
     ...
     * {@link ExpandableHListViews#getPackedPositionType} ,
     * {@link ExpandableHListViews#getPackedPositionChild},
     * {@link ExpandableHListViews#getPackedPositionGroup} to unpack.
     *
     ...
     *
     * @param packedPosition The group and/or child positions to be converted in packed
    ...
    public int getFlatListPosition(long packedPosition) {
        ExpandableHListPos elPackedPos = ExpandableHListPos
    ...
    public void setSelectedGroup(int groupPosition) {
        ExpandableHListPos elGroupPos = ExpandableHListPos
    ...
    public boolean setSelectedChild(int groupPosition, int childPosition,
        ...
        ExpandableHListPos elChildPos = ExpandableHListPos
                .obtainChildPosition(groupPosition, childPosition);
        ExpandableHListConnect.PositionMetadata flatChildPos = mConnector
    ...
    ContextMenuInfo createContextMenuInfo(View view, int flatListPosition,
        ...
        ExpandableHListConnect.PositionMetadata pm = mConnector
                .getUnflattenedPos(adjustedPosition);
        ExpandableHListPos pos = pm.position;
     ...
     *                 returned.
     */
    private long getChildOrGroupId(ExpandableHListPos position) {
        if (position.type == ExpandableHListPos.CHILD) {
     ...
     *
     * @param childIndicator The drawable to be used as an indicator. If the child is the
     ...
     *
     * @param groupIndicator The drawable to be used as an indicator. If the group is
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(ExpandableHListViews.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(ExpandableHListViews.class.getName());
    }
    ...
    public interface OnGroupClickListener {
         ...
         */
        boolean onGroupClick(ExpandableHListViews parent, View v,
    ...
    public interface OnChildClickListener {
         ...
         * @return True if the click was handled
         */
        boolean onChildClick(ExpandableHListViews parent, View v,
                             int groupPosition, int childPosition, long id);
    }

    /**
     * Extra menu information specific to an {@link ExpandableHListViews}
     * provided to the
    ...
    public static class ExpandableListContextMenuInfo implements
         ...
         * one of the children Views of this {@link ExpandableHListViews}.
         */
         ...
         * {@link ExpandableHListViews#getPackedPositionType},
         * {@link ExpandableHListViews#getPackedPositionChild}, and
         * {@link ExpandableHListViews#getPackedPositionGroup} to unpack this.
         */
    ...
    static class SavedState extends BaseSavedState {
        ...
        ArrayList<ExpandableHListConnect.GroupMetadata> expandedGroupMetadataList;

        /**
         * Constructor called from
         * {@link ExpandableHListViews#onSaveInstanceState()}
         */
        SavedState(
        ...
        private SavedState(Parcel in) {
            super(in);
            expandedGroupMetadataList = new ArrayList<ExpandableHListConnect.GroupMetadata>();
            in.readList(expandedGroupMetadataList,
                    ExpandableHListConnect.class.getClassLoader());
        }
