...
public class OverScrollerView {
     ...
     *                     be used.
     */
    public OverScrollerView(Context context, Interpolator interpolator) {
     ...
     * @hide
     */
    public OverScrollerView(Context context, Interpolator interpolator, boolean flywheel) {
