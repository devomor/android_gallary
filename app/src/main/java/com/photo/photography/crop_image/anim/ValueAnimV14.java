...
public class ValueAnimV14
        implements SimpleValueAnim, Animator.AnimatorListener,
        ValueAnimator.AnimatorUpdateListener {
    private static final int DEFAULT_ANIMATION_DURATION = 150;
    private final ValueAnimator animator;
    private CallbackSimpleValueAnim animatorListener = new CallbackSimpleValueAnim() {
        @Override
    ...
    public ValueAnimV14(Interpolator interpolator) {
    ...
    @Override
    public void addAnimatorListener(CallbackSimpleValueAnim animatorListener) {
