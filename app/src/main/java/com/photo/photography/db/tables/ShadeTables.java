...
public class ShadeTables extends BaseTables {
    public static final String FRAME_TYPE = ItemPackageTables.FRAME_TYPE;//"frame";
    public static final String SHADE_TYPE = ItemPackageTables.SHADE_TYPE;//"shade";
    // Table structure
    ...
    public ShadeTables(Context context) {
        super(context);
    }
