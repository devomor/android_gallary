...
public class Utils {
    ...
    public static double distance(Point p1, Point p2) {
        ...
        double dist = SquareRoots.fastSqrt(xSqr + ySqr);
        return dist;
    }
    ...
    public static Bitmap createScaledBitmap(Bitmap unscaledBitmap, int dstWidth, int dstHeight, ScalingUtils.ScalingLogic scalingLogic) {
    ...
    public static Rect calculateSrcRect(int srcWidth, int srcHeight, int dstWidth, int dstHeight, ScalingUtils.ScalingLogic scalingLogic) {
        if (scalingLogic == ScalingUtils.ScalingLogic.CROP) {
    ...
    public static Rect calculateDstRect(int srcWidth, int srcHeight, int dstWidth, int dstHeight, ScalingUtils.ScalingLogic scalingLogic) {
        if (scalingLogic == ScalingUtils.ScalingLogic.FIT) {
            final float srcAspect = (float) srcWidth / (float) srcHeight;
            final float dstAspect = (float) dstWidth / (float) dstHeight;
    ...
    public static Bitmap copyBitmapFromImage(AppCompatImageView ivSrc) {
    ...
    public static String getColorAsString(int color) {
        ...
        String sColor = "Red: " + red + " Green: " + green + " Blue: " + blue;
