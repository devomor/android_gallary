...
public class SwipeBacksLayout extends ViewGroup {
    ...
    private final OnSwipeBackListener defaultSwipeBackListener = new OnSwipeBackListener() {
        @Override
    ...
    public SwipeBacksLayout(@NonNull Context context) {
        this(context, null);
    }

    public SwipeBacksLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeBacksLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
