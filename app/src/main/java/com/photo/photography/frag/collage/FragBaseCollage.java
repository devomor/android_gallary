package com.photo.photography.frag.collage;
...
import com.photo.photography.act.ActDownloadedPackage;
import com.photo.photography.act.ActSelectPhoto;
...
public class FragBaseCollage extends Fragment {
    ...
    private void startPhotoEditor(Uri imageUri, boolean capturedFromCamera) {
        ...
        AppLog.d("BaseCollageFragment", "startPhotoEditor, imageUri=" + imageUri + ", capturedFromCamera=" + capturedFromCamera);
...
//        startActivityForResult(newIntent, REQUEST_PHOTO_EDITOR_CODE);
    ...
    public void pickMultipleImageFromGallery() {
        Intent data = new Intent(getActivity(), ActSelectPhoto.class);
        data.putExtra(ActSelectPhoto.EXTRA_IMAGE_COUNT, MAX_NEEDED_PHOTOS);
        data.putExtra(ActSelectPhoto.EXTRA_IS_MAX_IMAGE_COUNT, true);
    ...
    public void pickSticker() {
        ...
        Intent intent = new Intent(getActivity(), ActDownloadedPackage.class);
...
//    }
    ...
    protected Uri getImageUri() {
        // Store image in dcim
        File file = new File(new VaultFileUtil(mActivity).getFile("support"), CAPTURE_TITLE);
