 ...
 * @author vanhu_000
 */
public class ItemInfoModel implements Parcelable {
    ...
    public static final Parcelable.Creator<ItemInfoModel> CREATOR
            = new Parcelable.Creator<ItemInfoModel>() {
        public ItemInfoModel createFromParcel(Parcel in) {
            return new ItemInfoModel(in);
        }

        public ItemInfoModel[] newArray(int size) {
            return new ItemInfoModel[size];
        }
    };
    ...
    protected ItemInfoModel(Parcel in) {
