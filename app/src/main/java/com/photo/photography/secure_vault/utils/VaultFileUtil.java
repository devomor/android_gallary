...
public class VaultFileUtil {
    ...
    public static final String FOLDER_SAVE_DB_FILE = "gallerydb";
...
//        dirShareFiles = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + File.separator + "Gallery Pro");
        dirShareFiles = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + File.separator + "Gallery Pro");
