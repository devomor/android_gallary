...
public class RatingDialogs extends AppCompatDialog implements RatingBar.OnRatingBarChangeListener, View.OnClickListener {
    ...
    public RatingDialogs(Context context, Builder builder) {
        super(context);
...
//        tvTitle.setTextColor(builder.titleTextColor != 0 ? ContextCompat.getColor(context, builder.titleTextColor) : ContextCompat.getColor(context, R.color.black_new));
...
//        tvFeedback.setTextColor(builder.titleTextColor != 0 ? ContextCompat.getColor(context, builder.titleTextColor) : ContextCompat.getColor(context, R.color.black_new));
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.dialog_rating_button_negative) {
            ...
            if (TextUtils.isEmpty(feedback)) {
                ...
                Animation shake = AnimationUtils.loadAnimation(context, R.anim.anim_shakes);
...
//        showNever();
    ...
    private void setRatingThresholdClearedListener() {
        builder.ratingThresholdClearedListener = new Builder.RatingThresholdClearedListener() {
            @Override
            public void onThresholdCleared(RatingDialogs ratingDialog, float rating, boolean thresholdCleared) {
    ...
    private void setRatingThresholdFailedListener() {
        builder.ratingThresholdFailedListener = new Builder.RatingThresholdFailedListener() {
            @Override
            public void onThresholdFailed(RatingDialogs ratingDialog, float rating, boolean thresholdCleared) {
                openForm();
            }
        };
    }
...
//            this.playstoreUrl = "market://details?id=" + context.getPackageName();
            this.playstoreUrl = "market://details?id=" + BuildConfig.APPLICATION_ID;
            initText();
        }
        ...
        public RatingDialogs build() {
            RatingDialogs ratingDialog = new RatingDialogs(context, this);
            return ratingDialog;
        }

        public interface RatingThresholdClearedListener {
            void onThresholdCleared(RatingDialogs ratingDialog, float rating, boolean thresholdCleared);
        }

        public interface RatingThresholdFailedListener {
            void onThresholdFailed(RatingDialogs ratingDialog, float rating, boolean thresholdCleared);
        }
