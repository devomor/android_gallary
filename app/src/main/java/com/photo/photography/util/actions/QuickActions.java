 ...
 */
public class QuickActions extends PopupWindow implements OnDismissListener {
    ...
    private final List<QuickActionsItem> mQuickActionItems = new ArrayList<QuickActionsItem>();
     ...
     */
    public QuickActions(Context context, int orientation) {
        super(context);
     ...
     */
    public QuickActionsItem getActionItem(int index) {
     ...
     * Add action item
     *
     * @param action {@link QuickActionsItem}
     */
    public void addActionItem(QuickActionsItem action) {
        ...
        container.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mItemClickListener != null) {
                    mItemClickListener.onItemClick(QuickActions.this, pos, actionId);
                }
     ...
     */
    public void setOnDismissListener(QuickActions.OnDismissListener listener) {
    ...
    public interface OnActionItemClickListener {
        void onItemClick(QuickActions source, int pos, int actionId);
    }
