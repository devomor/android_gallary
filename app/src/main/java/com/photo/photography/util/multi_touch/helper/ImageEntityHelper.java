...
public class ImageEntityHelper extends MultiTouchEntityHelper {
    public static final Parcelable.Creator<ImageEntityHelper> CREATOR = new Parcelable.Creator<ImageEntityHelper>() {
        @Override
        public ImageEntityHelper createFromParcel(Parcel in) {
            return new ImageEntityHelper(in);
        }

        @Override
        public ImageEntityHelper[] newArray(int size) {
            return new ImageEntityHelper[size];
        }
    };
    ...
    public ImageEntityHelper(int resourceId, Resources res) {
        super(res);
    ...
    public ImageEntityHelper(Uri image, Resources res) {
        super(res);
        mImageUri = image;
        mResourceId = -1;
        loadConfigs(res);
    ...
    public ImageEntityHelper(ImageEntityHelper e, Resources res) {
        super(res);
    ...
    protected ImageEntityHelper(Parcel in) {
        readFromParcel(in);
    }
