...
public abstract class MultiTouchEntityHelper implements Parcelable {
    ...
    public MultiTouchEntityHelper() {
    }

    public MultiTouchEntityHelper(Resources res) {
        getMetrics(res);
    }
     ...
     */
    public boolean setPos(MultiTouchHelper.PositionAndScale newImgPosAndScale) {
        float newScaleX;
        float newScaleY;
