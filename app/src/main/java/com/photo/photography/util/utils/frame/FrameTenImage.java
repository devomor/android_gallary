...
public class FrameTenImage {
    static TemplateItemModel collage_10_8() {
        TemplateItemModel item = FrameImageUtils.collage("collage_10_8.png");
        //first frame
    ...
    static TemplateItemModel collage_10_7() {
        TemplateItemModel item = FrameImageUtils.collage("collage_10_7.png");
        //first frame
        PhotosItem photoItem = new PhotosItem();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.2f, 0.2f);
    ...
    static TemplateItemModel collage_10_6() {
        TemplateItemModel item = FrameImageUtils.collage("collage_10_6.png");
        //first frame
        PhotosItem photoItem = new PhotosItem();
        photoItem.index = 0;
    ...
    static TemplateItemModel collage_10_5() {
        TemplateItemModel item = FrameImageUtils.collage("collage_10_5.png");
        //first frame
        PhotosItem photoItem = new PhotosItem();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.5f, 0.25f);
    ...
    static TemplateItemModel collage_10_4() {
        TemplateItemModel item = FrameImageUtils.collage("collage_10_4.png");
        //first frame
        PhotosItem photoItem = new PhotosItem();
        photoItem.index = 0;
    ...
    static TemplateItemModel collage_10_3() {
        TemplateItemModel item = FrameImageUtils.collage("collage_10_3.png");
        //first frame
        PhotosItem photoItem = new PhotosItem();
        photoItem.index = 0;
    ...
    static TemplateItemModel collage_10_2() {
        TemplateItemModel item = FrameImageUtils.collage("collage_10_2.png");
        //first frame
        PhotosItem photoItem = new PhotosItem();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.5f, 0.5f);
    ...
    static TemplateItemModel collage_10_1() {
        TemplateItemModel item = FrameImageUtils.collage("collage_10_1.png");
        //first frame
        PhotosItem photoItem = new PhotosItem();
        photoItem.index = 0;
    ...
    static TemplateItemModel collage_10_0() {
        TemplateItemModel item = FrameImageUtils.collage("collage_10_0.png");
        //first frame
        PhotosItem photoItem = new PhotosItem();
        photoItem.index = 0;
        photoItem.bound.set(0, 0, 0.2f, 0.2f);
