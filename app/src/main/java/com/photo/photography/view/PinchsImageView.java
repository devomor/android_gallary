 ...
 * @author clifford
 */
public class PinchsImageView extends ImageView {
     ...
     * 在onTouchEvent末尾被执行.
     */
    private final GestureDetector mGestureDetector = new GestureDetector(PinchsImageView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(PinchsImageView.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if (mOnClickListener != null) {
                mOnClickListener.onClick(PinchsImageView.this);
            }
            return true;
        }
    });
    ...
    public PinchsImageView(Context context) {
        super(context);
        initView();
    }

    public PinchsImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public PinchsImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean canScrollHorizontally(int direction) {
        if (mPinchMode == PinchsImageView.PINCH_MODE_SCALE) {
            return true;
        }
    ...
    public interface OuterMatrixChangedListener {
         ...
         */
        void onOuterMatrixChanged(PinchsImageView pinchImageView);
    }
