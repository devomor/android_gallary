...
public final class CustomExoPlayersView extends FrameLayout {
    ...
    public CustomExoPlayersView(Context context) {
        this(context, null);
    }
    ...
    public CustomExoPlayersView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int rewindMs = CustomPlayBackControllers.DEFAULT_REWIND_MS;
        int fastForwardMs = CustomPlayBackControllers.DEFAULT_FAST_FORWARD_MS;
        int controllerShowTimeoutMs = CustomPlayBackControllers.DEFAULT_SHOW_TIMEOUT_MS;
    ...
    public void fullScreenModeEnable(Activity mActivity) {
        int navBarHeight = Util.getNavigationBarHeight(mActivity);
        Log.e("GAL_TAG", "navBarHeight : " + navBarHeight);
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) controller.getLayoutParams();
        layoutParams.setMargins(Util.dp2px(getResources(), 14), 0, Util.dp2px(getResources(), 14), navBarHeight + Util.dp2px(getResources(), 14));
