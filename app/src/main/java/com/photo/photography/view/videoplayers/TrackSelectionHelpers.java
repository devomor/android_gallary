 ...
 */
/* package */ public final class TrackSelectionHelpers implements View.OnClickListener,
     ...
     */
    public TrackSelectionHelpers(MappingTrackSelector selector, TrackSelection.Factory adaptiveVideoTrackSelectionFactory) {
  ...
  /*public TrackSelectionHelper(MappingTrackSelector selector,
    ...
    private View buildView(LayoutInflater inflater) {
        View view = inflater.inflate(R.layout.track_selection_dialogs, null);
        ...
        for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
                if (trackIndex == 0) {
                    root.addView(inflater.inflate(R.layout.list_dividers, root, false));
                }
